...
vim.list_extend(mason.tools, { "terraform", "terraform-ls" })

-- Install Treesitter language
vim.list_extend(treesitter.ensure_installed, { "hcl" })

-- Setup conform
conform.opts.formatters_by_ft.terraform = { "terraform_fmt" }
conform.opts.formatters_by_ft.tf = { "terraform_fmt" }
conform.opts.formatters_by_ft.hcl = { "terraform_fmt" }
